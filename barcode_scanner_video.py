...
# vs = VideoStream(src=0).start()   # for USB web Cam 
vs = VideoStream(src=cv2.CAP_V4L).start()   # for USB web Cam (mod : 2022.11)
...
while True:
	...
	for barcode in barcodes:
		...
		if barcodeData not in found:
			...
			csv.flush()
			if barcodeData in result.values():
				temp = firebase.put("https://wintercapstonedesign-default-rtdb.firebaseio.com/","toESP_unlock","true")
